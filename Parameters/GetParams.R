...
sites <- read_sheet('https://docs.google.com/spreadsheets/d/1P9cPcdo6dPfOxnoFR3YfODIc_EqEfeUF1GuoDmNxvM0/edit#gid=0')
str(sites)
...
names(sites_trim)[(which(names(sites_trim)=='...5'))]<-'F_sed_oxy_gm2d'
